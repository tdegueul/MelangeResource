...
public class FSMAdapter extends EObjectImpl implements GenericAdapter<FSM>, melangefsm.fsmmt.FSM {
  private FSM adaptee;
  
  public FSM getAdaptee() {
    return this.adaptee;
  }
  
  public void setAdaptee(final FSM adaptee) {
